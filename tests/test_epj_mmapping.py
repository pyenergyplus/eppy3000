...
def test_epj_mapping_functions(make_epj):
    ...
    result = mm["Zone"]
    expected = [
        {"area": 15, "type": "conditioned", "eppykey": "Zone", "eppyname": "zone1"}
    ]
    ...
    # completely new item
    newval = [
        {"long": 15, "lat": 32, "eppykey": "Location", "eppyname": "City"},
    ...
    newval = [
        {"area": 105, "type": "unconditioned", "eppykey": "Zone", "eppyname": "zone2"}
    ]
    mm["Zone"] = newval
    expected = epjsequence2dict(newval)
